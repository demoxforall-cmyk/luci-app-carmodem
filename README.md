...
SMS/USSD-мессенджер: контакты слева, переписка справа; цветные аватары, разделители дат, время сообщений; три режима хранилища (SIM / Modem / Combined) с индикаторами заполнения; новое сообщение на новый номер; удаление с выделением; USSD внизу списка.
...
```sh
# просто: без сертификата, на любом apk-устройстве (можно из веб-терминала LuCI)
apk add --allow-untrusted /tmp/luci-app-carmodem-3.4-r1.apk
